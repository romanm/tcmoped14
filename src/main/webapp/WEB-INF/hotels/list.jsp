...
<h1>Hotel Results</h1>
<p>
	<a id="changeSearchLink" href="hotels/search?searchString=${searchCriteria.searchString
	}&pageSize=${searchCriteria.pageSize}">Change Search</a>
...
<p>
	<a id="popupTest1" href="hotels/search?searchString=${searchCriteria.searchString
	}&pageSize=${searchCriteria.pageSize}">popupTest1</a>
	<script type="text/javascript">
		Spring.addDecoration(new Spring.AjaxEventDecoration({
			elementId: "popupTest1",
			event: "onclick",
			popup: true,
			params: {fragments: "popupTest1"}
		}));
	</script>
</p>
<div id="hotelResults">
	...
	<div class="buttonGroup">
		...
		<div class="span-3 append-12 last">
			<c:if test="${not empty hotelList && fn:length(hotelList) == searchCriteria.pageSize}">
				<a id="moreResultsLink" href="hotels?searchString=${searchCriteria.searchString
				}&pageSize=${searchCriteria.pageSize}&page=${searchCriteria.page + 1}">More Results</a>
				<script type="text/javascript">
					Spring.addDecoration(new Spring.AjaxEventDecoration({
