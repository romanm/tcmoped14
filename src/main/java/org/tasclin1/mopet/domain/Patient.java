...
public class Patient implements MObject, Serializable, Comparable<Patient> {
    ...
    public DateTime getBirthdateDT() {
	if (null == birthdateDT)
	    birthdateDT = new DateTime(birthdate.getTime());
	return birthdateDT;
    }
    ...
    public int compareTo(MObject p) {
	return compareTo((Patient) p);
    }
	...
	return "patient:" + id + ":patient:" + patient + ":forename:" + forename + ":sex:" + sex + ":birthdate:"
		+ birthdate;
    }
}