...
public class Dose implements MObject, Serializable, Comparable<Dose> {
	...
	return null != value && value == value.intValue();
    }
    ...
    public void setValue(Integer doseDef) {
	setValue(doseDef.floatValue());
    }
	...
	return "dose:" + getId() + ":type:" + type + ":app:" + app + ":unit:" + unit + ":value:" + value + ":pro:"
		+ pro;
    }

    public int compareTo(MObject t) {
	return compareTo((Dose) t);
    }
    ...
    public boolean hasDose2DoseCalc() {
	return hasUnit() && (unit.indexOf("/l") > 0 || unit.indexOf("/g") > 0);
    }
    ...
    /*
     * @Transient private String calcDoseR; public String getCalcDoseR() {return calcDoseR;} public void
     * setCalcDoseR(String string) { this.calcDoseR=string; System.out.println(this+"...."+calcDoseR); }
     */
